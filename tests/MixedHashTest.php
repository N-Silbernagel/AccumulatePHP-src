...
{
    /** @test */
    public function it_should_compute_to_given_int()
    {
    ...
    /** @test */
    public function it_should_compute_to_given_string()
    {
    ...
    /** @test */
    public function it_should_throw_for_resource()
    {
    ...
    /** @test */
    public function it_should_return_object_hash_for_object()
    {
        $obj = (object)[];
    ...
    /** @test */
    public function it_should_return_hashcode_for_hashable()
    {
